...
export const projects = [
    ...
    },
    {
        ...
        role: 'Creator',
        description: 'A performance-focused reference guide for developers.',
        challenge: 'Creating a blazing fast, zero-config reference tool.',
        solution: 'Built with Next.js and Tailwind for edge deployment and optimal core web vitals.',
